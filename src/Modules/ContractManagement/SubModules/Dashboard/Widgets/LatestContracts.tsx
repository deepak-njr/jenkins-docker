...
export const LatestContracts = ({ data, isLoading }: Props) => {
  ...
  const columns: TableColumnsType = [
    ...
    },
    {
      ...
      ellipsis: true,
      sorter: (a: any, b: any) => Number(new Date(a.startDate)) - Number(new Date(b.startDate)),
    },
    {
      title: "Status",
      dataIndex: "status",
  ...
  return (
    <WrapperCard
      title={<Link to="/clm/contracts">Latest Onboarded Contracts</Link>}
